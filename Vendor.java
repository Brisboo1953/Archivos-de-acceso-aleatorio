...
public class Vendor {
    ...
    private double ventasMensuales; // Nuevo campo para almacenar las ventas mensuales

    public Vendor(int codigo, String nombre, Date fecha, String zona, double ventasMensuales) {
        super();
        ...
        this.setFecha(fecha);
        this.setZona(zona);
        this.setVentasMensuales(ventasMensuales); // Inicializa el campo de ventas mensuales
    }
    ...
    public String toString() {
        ...
        // Regresa una cadena en formato CSV con el campo de ventas mensuales
        return codigo + "," + nombre + "," + f.format(fecha) + "," + zona + "," + ventasMensuales;
    }
